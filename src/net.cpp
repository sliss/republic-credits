...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RepublicCredits " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"republiccreditstools.com", "dnsseed.republiccreditstools.com"},
    {"republiccreditspool.org", "dnsseed.republiccreditspool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"republiccreditstools.com", "testnet-seed.republiccreditstools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RepublicCredits is probably already running."), addrBind.ToString().c_str());
        else
